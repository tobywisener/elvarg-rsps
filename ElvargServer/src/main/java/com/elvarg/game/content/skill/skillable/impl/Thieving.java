    ...
    public static final class Pickpocketing {
        ...
        private static boolean hasRequirements(Player player, NPC npc, Pickpocketable p) {
            ...
            if (player.getSkillManager().getCurrentLevel(Skill.THIEVING) < p.getLevel()) {
                StatementDialogue.send(player, "You need a Thieving level of at least " + Integer.toString(p.getLevel()) + " to do this.");
                return false;
            }
        ...
        public enum Pickpocketable {
            MAN_WOMAN(1, 8, 5, 1, new Item[]{new Item(COINS, 3)}, 3014, 3015, 3078, 3079, 3080, 3081, 3082, 3083,
                    3084, 3085, 3267, 3268, 3260, 3264, 3265, 3266, 3267, 3268),
            FARMER(10, 15, 5, 1,
                    new Item[]{new Item(COINS, 9), new Item(POTATO_SEED)}, NpcIdentifiers.FARMER, NpcIdentifiers.FARMER_2, NpcIdentifiers.FARMER_3, NpcIdentifiers.FARMER_4, NpcIdentifiers.FARMER_5, NpcIdentifiers.FARMER_6,
                    NpcIdentifiers.FARMER_7, NpcIdentifiers.FARMER_8, NpcIdentifiers.FARMER_9, NpcIdentifiers.FARMER_10, NpcIdentifiers.FARMER_11, NpcIdentifiers.FARMER_12, NpcIdentifiers.FARMER_13, NpcIdentifiers.FARMER_14, NpcIdentifiers.FARMER_15,
                    NpcIdentifiers.FARMER_16),
            ...
            MASTER_FARMER(38, 43, 5, 3,
                    ...
                    NpcIdentifiers.MASTER_FARMER, NpcIdentifiers.MASTER_FARMER_2),
            GUARD(40, 47, 5, 2,
